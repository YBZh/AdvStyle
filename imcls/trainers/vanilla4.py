...
from dassl.modeling.ops import first_order, second_order, first_second_order, all_order #, third_order, fourth_order, first_second_three_order, first_second_three_four_order
import numpy as np
import os.path as osp
# import ipdb

@TRAINER_REGISTRY.register()
class Vanilla4(TrainerX):
    """Vanilla baseline.
    ...
    def __init__(self, cfg):
        ...
        if mix == 'one':
            self.model.apply(first_order)
            print('MixStyle: random mixing')

        elif mix == 'two':
            self.model.apply(second_order)
