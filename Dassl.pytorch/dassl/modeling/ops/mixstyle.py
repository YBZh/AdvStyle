...
class MixStyle(nn.Module):
    ...
    def __init__(self, p=0.5, alpha=0.1, eps=1e-6, mix='random'):
        ...
        # self.adv_mean_std = torch.nn.Parameter(torch.FloatTensor(1,1,1,1), requires_grad=True)
        # self.adv_mean_std.data.fill_(0.1)  ## initialization
        # self.adv_std_std = torch.nn.Parameter(torch.FloatTensor(1,1,1,1), requires_grad=True)
