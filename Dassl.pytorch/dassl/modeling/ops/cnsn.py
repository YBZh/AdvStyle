...
class CNSN(nn.Module):
    ...
    def __init__(self, p=0.5, alpha=0.1, eps=1e-6, mix='random', crop='neither', beta=1.0, chan_num=0):
        """
        Args:
        ...
        self.crossnorm = CrossNorm(crop=crop, beta=beta)
        self.selfnorm = SelfNorm(chan_num)
