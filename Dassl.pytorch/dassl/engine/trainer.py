...
class our_classifier(nn.Module):
    def __init__(self, in_dim, num_classes, layer4):
        super().__init__()
        self.layer4 = layer4
...
class SimpleTrainer(TrainerBase):
    ...
    def test(self, split=None):
        ...
        for batch_idx, batch in enumerate(data_loader):
            ...
            if batch_idx == 0 or batch_idx == (len(data_loader)-1):
                pass
            else:
                num_all = num_all + input.size(0)
            ...
            if batch_idx == 0 or batch_idx == (len(data_loader)-1):
                ...
                # print(elapsed)
                time_all = time_all + elapsed
            self.evaluator.process(output, label)
        print(num_all)
        print(time_all)
        print(time_all/num_all)
